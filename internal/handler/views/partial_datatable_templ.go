...
func DtRowPerPage(url, hxTarget string, rowsPerPage int, q interface{}) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("%s?%s", url, paging.EncodedQuery(q, []string{"limit"})))
		if templ_7745c5c3_Err != nil {
		...
		for _, page := range availablePages {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("%d", page))
			if templ_7745c5c3_Err != nil {
...
func DtRefreshInterval(url, hxTarget, interval string, q interface{}) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("%s?%s", url, paging.EncodedQuery(q, []string{"refresh"})))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.ResolveAttributeValue(hxTarget)
		if templ_7745c5c3_Err != nil {
		...
		for _, v := range refreshIntevals {
			...
			templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.ResolveAttributeValue(v)
			if templ_7745c5c3_Err != nil {
		...
		if slices.Contains(refreshIntevals, interval) {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("%s?%s", url, paging.EncodedQuery(q, []string{""})))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.ResolveAttributeValue(hxTarget)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("every %s", interval))
			if templ_7745c5c3_Err != nil {
...
func DtReload(url, hxTarget string, q interface{}) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("%s?%s", url, paging.EncodedQuery(q, []string{""})))
		if templ_7745c5c3_Err != nil {
...
func DtThSort(url, hxTarget, title, expectedSort, sortBy, sortDir string, q interface{}) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if expectedSort == sortBy && sortDir == "asc" {
			...
			templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("%s?sort_by=%s&sort_direction=desc&%s", url, expectedSort, paging.EncodedQuery(q, []string{"sort_by", "sort_direction"})))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.ResolveAttributeValue(string(templ.URL(fmt.Sprintf("%s?sort_by=%s&sort_direction=asc&%s", url, expectedSort, paging.EncodedQuery(q, []string{"sort_by", "sort_direction"})))))
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var24, templ_7745c5c3_Err = templ.ResolveAttributeValue(hxTarget)
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Var25, templ_7745c5c3_Err = templ.ResolveAttributeValue(string(templ.URL(fmt.Sprintf("%s?sort_by=%s&sort_direction=desc&%s", url, expectedSort, paging.EncodedQuery(q, []string{"sort_by", "sort_direction"})))))
			if templ_7745c5c3_Err != nil {
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, page := range p.Pages {
			if page == -1 {
				...
				templ_7745c5c3_Var34, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("%s?%s&page=%d", url, paging.EncodedQuery(q, []string{"page"}), page))
				if templ_7745c5c3_Err != nil {
